...
3. Install the necessary dependencies with `bun install`.
4. Run the development environment with `bun run dev` to test your changes.
...
- Follow the existing code style and conventions (TypeScript/SolidJS).
...
When participating in the community, please be respectful and considerate of others. Follow these guidelines:
