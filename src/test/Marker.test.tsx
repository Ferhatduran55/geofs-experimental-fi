import { defs } from "../assets/filters/AircraftMarkerDefs.tsx";
import Marker from "../classes/Marker.tsx";
import { describe, it } from "vitest";

describe("Marker test", () => {
  let defaultTest: Marker;

  it("Initializing", () => {
    defaultTest = new Marker({
      width: 40,
      height: 40,
      viewBox: "0 0 40 40",
      defs: [defs.outline],
