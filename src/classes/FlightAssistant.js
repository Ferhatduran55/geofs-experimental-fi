class FlightAssistant {
    ...
    renderFlightAssistantContainer(gen) {
        ...
        gen.append(`<style>#flightAssistantSetMaxRPM:focus{outline: 0;border: 0;box-shadow: 0px 0px 8px 2px rgb(0 0 0 / 45%) !important;}</style>`)
        gen.append($("<input>", {
            id: "flightAssistantSetMaxRPM",
            style: "width: 90%;margin: 1% 4%;border: 0;border-radius: 5px;padding: 2%;box-shadow: 0px 0px 8px 1px rgb(0 0 0 / 40%);",
            type: "number",
